...
reference_data = pd.read_excel(r'D:\BRIN\HKI\Hak Cipta\Sampel Mikroplastik\Jakarta Excel\HDPE (1).xlsx')

# Data sampel baru (pastikan path-nya benar)
new_data = pd.read_excel(r'D:\BRIN\HKI\Hak Cipta\Sampel Mikroplastik\Jakarta Excel\BKT (1).xlsx')
